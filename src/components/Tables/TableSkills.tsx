              ...
              <DrawerHeader>
                ...
                <DrawerDescription className="pt-5 text-black dark:text-white">
                  <form action="">
                    ...
                    <div className="mt-8">
                      <button className="inline-flex w-full items-center justify-center gap-2.5 rounded-md bg-primary px-4 py-3 text-center font-medium text-white hover:bg-opacity-90 lg:px-5 xl:px-8">
                        Submit
                      </button>
                    </div>
                  </form>
            ...
            {skills &&
              skills.map((skill, key) => (
                <tr key={skill.id}>
                  ...
                  <td className="border-b border-[#eee] px-4 py-5 dark:border-strokedark">
                    <Image src={baseUrl+skill.icon} width={50} height={50} alt={""} />
                  </td>
                  <td className="border-b border-[#eee] px-4 py-5 dark:border-strokedark">
